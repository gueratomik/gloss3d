    ...
    do {
        ...
        switch ( chunkSignature ) {
            case SIG_OBJECT_TEXT_FONT_FILE : {
                ...
                g3dimportv3_fread ( fontFile, chunkSize, 0x01, fsrc );
            } break;
            ...
            case SIG_OBJECT_TEXT_FONT_FACE : {
                ...
                g3dimportv3_fread ( fontFace, chunkSize, 0x01, fsrc );
            } break;
            ...
            case SIG_OBJECT_TEXT_FONT_SIZE : {
                ...
                g3dimportv3_freadl ( &fontSize, fsrc );
            ...
            case SIG_OBJECT_TEXT_THICKNESS : {
                ...
                g3dimportv3_freadf ( &txt->thickness, fsrc );
            } break;

            case SIG_OBJECT_TEXT_ROUNDNESS : {
                G3DTEXT *txt = ( G3DTEXT * ) gid->currentObject;

                g3dimportv3_freadl ( &txt->roundness, fsrc );
            } break;
