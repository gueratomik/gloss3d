...
GtkWidget* createCoordinatesEdit ( GtkWidget *parent, G3DUI *gui,
    ...
    createFloatText   ( frm, gui, EDITXPOSITION,   0, 24, 0, 64, posCbk );
    createFloatText   ( frm, gui, EDITYPOSITION,   0, 48, 0, 64, posCbk );
    createFloatText   ( frm, gui, EDITZPOSITION,   0, 72, 0, 64, posCbk );

    createSimpleLabel ( frm, gui, "Rotation"   ,  96,  0, 0, 48 );
    createFloatText   ( frm, gui, EDITXROTATION,  96, 24, 0, 64, rotCbk );
    createFloatText   ( frm, gui, EDITYROTATION,  96, 48, 0, 64, rotCbk );
    createFloatText   ( frm, gui, EDITZROTATION,  96, 72, 0, 64, rotCbk );

    createSimpleLabel ( frm, gui, "Scaling"    , 192,  0, 0, 48 );
    createFloatText   ( frm, gui, EDITXSCALING , 192, 24, 0, 64, scaCbk );
    createFloatText   ( frm, gui, EDITYSCALING , 192, 48, 0, 64, scaCbk );
    createFloatText   ( frm, gui, EDITZSCALING , 192, 72, 0, 64, scaCbk );
