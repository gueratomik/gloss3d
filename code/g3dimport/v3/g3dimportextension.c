...
void g3dimportv3extension ( G3DIMPORTV3DATA *gid, uint32_t chunkEnd, FILE *fsrc ) {
    ...
    do {
        ...
        G3DIMPORTV3EXTENSION *ext = g3dimportv3extension_getFromList ( chunkSignature, gid->lext );
...
G3DIMPORTV3EXTENSION *g3dimportv3extension_new ( uint32_t signature,
                                             void (*read)( G3DIMPORTV3DATA *gid,
                                                           ...
                                                           void          *data ),
                                             void *data) {
    uint32_t size = sizeof ( G3DIMPORTV3EXTENSION );
    G3DIMPORTV3EXTENSION *ext = ( G3DIMPORTV3EXTENSION * ) calloc ( 0x01, size );

    if ( ext == NULL ) {
        fprintf ( stderr, "g3dimportv3extension_new: calloc failed\n");
...
G3DIMPORTV3EXTENSION *g3dimportv3extension_getFromList ( uint32_t signature,
    ...
    while ( ltmpext ) {
        G3DIMPORTV3EXTENSION *ext = ( G3DIMPORTV3EXTENSION * ) ltmpext->data;
