...
/******************************************************************************/
static uint32_t g3dexportv3wireframe_geometry ( G3DEXPORTV3DATA *ged, 
                                              G3DWIREFRAME  *wfm, 
                                              uint32_t       flags, 
                                              FILE          *fdst ) {
    uint32_t size = 0x00;

    size += g3dexportv3_fwritef ( &wfm->thickness, fdst );
    size += g3dexportv3_fwritef ( &wfm->aperture , fdst );

    return size;
}

/******************************************************************************/
static uint32_t g3dexportv3wireframe_algo  ( G3DEXPORTV3DATA *ged, 
                                           G3DWIREFRAME  *wfm, 
                                           uint32_t       flags, 
                                           FILE          *fdst ) {
    ...
    size += g3dexportv3_fwritel ( &algo, fdst );
