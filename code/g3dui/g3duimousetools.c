...
void restrictcbk ( Widget w, XtPointer client, XtPointer call ) {
    ...
    G3DMOUSETOOL *mou = g3dui_getMouseTool ( gui, CUTMESHTOOL );
...
void updateCutMeshToolEdit ( Widget w ) {
    ...
    mou = g3dui_getMouseTool ( gui, CUTMESHTOOL );
...
void operationcbk ( Widget w, XtPointer client, XtPointer call ) {
    ...
    G3DUI *gui = ( G3DUI * ) client;
    G3DMOUSETOOL *mou = g3dui_getMouseTool ( gui, PICKTOOL );
    char *str;
...
void updatePaintWeightFrame ( Widget w ) {
    ...
    mou = g3dui_getMouseTool ( gui, PICKTOOL );
...
/******************************************************************************/
void updateCurrentMouseTool ( Widget w ) {
    G3DMOUSETOOL *mou;
    WidgetList children;
    G3DOBJECT *obj;
    G3DSCENE *sce;
...
/******************************************************************************/
Widget createCurrentMouseTool ( Widget parent, G3DUI *gui, char *name,
                                Dimension x    , Dimension y,
                                Dimension width, Dimension height ) {
    Pixel background, foreground;
    Widget scr, frm;
    ...
    /*createCubeEdit     ( frm, gui, EDITCUBENAME    , 0x00, 0x00, 0x140, 0x140 );
    createCylinderEdit ( frm, gui, EDITCYLINDERNAME, 0x00, 0x00, 0x140, 0x140 );
    createMeshEdit     ( frm, gui, EDITMESHNAME    , 0x00, 0x00, 0x140, 0x140 );
    createLightEdit    ( frm, gui, EDITLIGHTNAME   , 0x00, 0x00, 0x140, 0x140 );
    createSymmetryEdit ( frm, gui, EDITSYMMETRYNAME, 0x00, 0x00, 0x140, 0x140 );*/
