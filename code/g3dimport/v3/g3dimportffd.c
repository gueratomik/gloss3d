    ...
    do {
        ...
        switch ( chunkSignature ) {
            case SIG_OBJECT_FFD_GEOMETRY : {
                ...
                g3dimportv3_freadf ( &radx, fsrc );
                g3dimportv3_freadf ( &rady, fsrc );
                g3dimportv3_freadf ( &radz, fsrc );
            ...
            case SIG_OBJECT_FFD_UVW : {
                ...
                for ( i = 0x00; i < nbpnt; i++ ) {
                    ...
                    g3dimportv3_freadf ( &pnt->pos.x, fsrc );
                    g3dimportv3_freadf ( &pnt->pos.y, fsrc );
                    g3dimportv3_freadf ( &pnt->pos.z, fsrc );
                    /*** normal vector stores the local UVW coordinates ***/
                    g3dimportv3_freadf ( &pnt->nor.x, fsrc );
                    g3dimportv3_freadf ( &pnt->nor.y, fsrc );
                    g3dimportv3_freadf ( &pnt->nor.z, fsrc );
                }
            } break;
