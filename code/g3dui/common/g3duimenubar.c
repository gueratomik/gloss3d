...
/******************************************************************************/
static uint64_t g3dui_splitMeshCbk ( G3DUIMENU *menu, 
                                     void      *data ) {
    const gchar *option = gtk_widget_get_name  ( widget );
    G3DUI *gui = ( G3DUI * ) user_data;

    g3dui_splitMeshCbk ( gui, option );
}

/******************************************************************************/
uint64_t g3dui_mirrorHeightmapCbk ( GtkWidget *widget, gpointer user_data ) {
    const gchar *option = gtk_widget_get_name  ( widget );
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_mirrorWeightGroupCbk ( GtkWidget *widget, gpointer user_data ) {
    const gchar *option = gtk_widget_get_name  ( widget );
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_resetBoneTreeCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_resetBoneCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_fixBoneTreeCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_fixBoneCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addSymmetryCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addInstanceCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addEmitterCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addWireframeCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addSubdividerCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addSplineRevolverCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addFFDBoxCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addMorpherCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addSkinCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addPlaneCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addCubeCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addSphereCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addTorusCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addCylinderCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addTubeCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addLightCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addCameraCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addEmptyMeshCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addSplineCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addTextCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_addNullCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_invertNormalCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_alignNormalsCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_triangulateCbk ( GtkWidget *widget, gpointer user_data ) {
    const gchar *option = gtk_widget_get_name  ( widget );
...
/******************************************************************************/
uint64_t g3dui_untriangulateCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_weldVerticesCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_deleteLoneVerticesCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_selectAllCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_invertSelectionCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
...
/******************************************************************************/
uint64_t g3dui_getObjectStatsCbk ( GtkWidget *widget, gpointer user_data ) {
    G3DUI *gui = ( G3DUI * ) user_data;
    char buffer[0x200] = { 0 };
    GtkWidget *dialog;
...
/******************************************************************************/
uint64_t g3dui_selectTreeCbk ( GtkWidget *widget, gpointer user_data ) {
