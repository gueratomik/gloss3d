...
void g3duimain_sizeAllocate ( G3DUIMAIN *grp, 
    ...
    grp->menurec.x      = 0x00;
    grp->menurec.y      = 0x00;
    grp->menurec.width  = width;
    grp->menurec.height = 0x20;

    /*** Tool Bar ***/
    grp->tbarrec.x      = 0x00;
    grp->tbarrec.y      = 0x20;
    grp->tbarrec.width  = width;
    grp->tbarrec.height = TOOLBARBUTTONSIZE;

    /*** Mode Bar ***/
    grp->mbarrec.x      = 0x00;
    grp->mbarrec.y      = grp->tbarrec.y + grp->tbarrec.height;
    grp->mbarrec.width  = 0x30;
    grp->mbarrec.height = height - grp->menurec.height - grp->tbarrec.height;

    /*** Upper Right Panel ***/
    grp->mbrdrec.x      = width  - 0x140;
    grp->mbrdrec.y      = grp->tbarrec.y + grp->tbarrec.height;
    grp->mbrdrec.width  = 0x140;
    grp->mbrdrec.height = height - grp->menurec.height - grp->tbarrec.height;

    /*** Quad View Panel ***/
    grp->quadrec.x      = 0x30;
    grp->quadrec.y      = grp->tbarrec.y + grp->tbarrec.height;
    grp->quadrec.width  = width  - grp->mbarrec.width  - grp->mbrdrec.width;
    grp->quadrec.height = grp->mbarrec.height - 0x2A;

    /*** Timeboard Panel ***/
    grp->timerec.x      = 0x30;
    grp->timerec.y      = grp->quadrec.y + grp->quadrec.height;
    grp->timerec.width  = grp->quadrec.width;
    grp->timerec.height = 0x18;

    /*** Information Panel ***/
    grp->inforec.x      = 0x30;
    grp->inforec.y      = grp->timerec.y + grp->timerec.height;
    grp->inforec.width  = grp->quadrec.width;
    grp->inforec.height = 0x12;
}
