    ...
    do {
        ...
        switch ( chunkSignature ) {
            ...
            case SIG_OBJECT_MESH_FACEGROUP_FACES : {
                ...
                g3dimportv3_freadl ( &nbFaces, fsrc );
            ...
            case SIG_OBJECT_MESH_WEIGHTGROUP_WEIGHTS : {
                ...
                g3dimportv3_freadl ( &nbWeights, fsrc );
            ...
            case SIG_OBJECT_MESH_GEOMETRY_VERTICES : {
                ...
                for ( i = 0x00; i < nbver; i++ ) {
                    ...
                    g3dimportv3_freadf ( &x       , fsrc );
                    g3dimportv3_freadf ( &y       , fsrc );
                    g3dimportv3_freadf ( &z       , fsrc );
                    g3dimportv3_freadl ( &verFlags, fsrc );
            ...
            case SIG_OBJECT_MESH_GEOMETRY_POLYGONS : {
                ...
                for ( i = 0x00; i < nbfac; i++ ) {
                    ...
                    g3dimportv3_freadl ( &v2ID, fsrc );
                    g3dimportv3_freadl ( &v3ID, fsrc );
