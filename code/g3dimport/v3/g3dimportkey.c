    ...
    do {
        ...
        switch ( chunkSignature ) {
            ...
            case SIG_OBJECT_KEY_FLAGS_TRANSLATION : {
                g3dimportv3_freadl ( &enable_translation, fsrc );
            } break;

            case SIG_OBJECT_KEY_FLAGS_ROTATION : {
                g3dimportv3_freadl ( &enable_rotation, fsrc );
            } break;

            case SIG_OBJECT_KEY_FLAGS_SCALING : {
                g3dimportv3_freadl ( &enable_scaling, fsrc );
            } break;

            case SIG_OBJECT_KEY_FLAGS_DATA : {
                g3dimportv3_freadl ( &enable_data, fsrc );
            } break;
            ...
            case SIG_OBJECT_KEY_DATA_MORPHER_SLOT_ID : {
                g3dimportv3_freadl ( &poseID, fsrc );
