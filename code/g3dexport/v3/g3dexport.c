...
uint32_t g3dexportv3_fwrited ( double *d, FILE *stream ) {
    return g3dexportv3_fwrite ( d, sizeof ( double ), 0x01, stream );
}

/******************************************************************************/
uint32_t g3dexportv3_fwritef ( float *f, FILE *stream ) {
    return g3dexportv3_fwrite ( f, sizeof ( float ), 0x01, stream );
}

/******************************************************************************/
uint32_t g3dexportv3_fwritel ( uint32_t *l, FILE *stream ) {
    return g3dexportv3_fwrite ( l, sizeof ( uint32_t ), 0x01, stream );
}

/******************************************************************************/
uint32_t g3dexportv3_fwritell ( uint64_t *ll, FILE *stream ) {
    return g3dexportv3_fwrite ( ll, sizeof ( uint64_t ), 0x01, stream );
}
...
uint32_t g3dexportv3_writeChunk ( uint32_t   chunkSignature,
    ...
    size += g3dexportv3_fwrite ( &chunkSignature, sizeof ( uint32_t  ), 0x01, fdst );

    size += g3dexportv3_fwrite ( &dummyChunkSize, sizeof ( uint32_t  ), 0x01, fdst );
    ...
    g3dexportv3_fwrite ( &chunkSize, sizeof ( uint32_t  ), 0x01, fdst );
